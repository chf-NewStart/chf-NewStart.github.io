  ...
  function renderShelf(){
    ...
    grouped.forEach(function(group,groupIndex){
      ...
      group.papers.forEach(function(ch){
        var wrap=document.createElement('div'),book=document.createElement('button'),move=document.createElement('button'),menu=document.createElement('div'),categorySearch=document.createElement('input'),categoryOptions=document.createElement('div'),isSelected=ch.id===selected.id,visualHash=paperVisualHash(ch),spine=WALL_NOTES[(visualHash>>>1)%WALL_NOTES.length],menuId='paper-category-menu-'+(++categoryMenuIndex);
