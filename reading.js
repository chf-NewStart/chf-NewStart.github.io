(function(){
  ...
  async function seedStarterGuide(){
    if(!pristineLibrary||state.chapters.length||syncCfg||gdriveOn()||location.protocol==='file:'||/^#(?:(?:phloem|carrel|margin)-setup|phloem-review)=/.test(location.hash))return false;
    try{
