...
`reading-library-stack.test.js` covers the layered category sheets: the
two-column handwritten sticky grid, category creation/renaming, moving papers,
selection, search, and mobile fit.
